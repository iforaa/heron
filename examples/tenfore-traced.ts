...
export const tenforeTraced: Character = character(
  ...
  () => {
    ...
    layer('art', () => {
      // s0  box [389 68 871 789]  length 1275px
      through([
      ...
      // s1  box [153 154 408 760]  length 832px
      through([
      ...
      // s2  box [301 113 545 579]  length 711px
      through([
      ...
      // s3  box [364 347 714 607]  length 518px
      through([
      ...
      // s6  box [504 738 569 954]  length 284px
      through([
        [504, 738], [508, 742], [508, 953], [569, 954],
      ], { stroke: INK, width: 36 });

      // s7  box [398 804 437 906]  length 167px
      through([
        [433, 804], [415, 811], [409, 822], [399, 863], [398, 900], [402, 905],
        [408, 906], [429, 900], [437, 890],
      ], { stroke: INK, width: 36.1 });

      // s8  box [504 636 596 738]  length 154px
      through([
        [596, 636], [542, 686], [512, 696], [508, 707], [508, 729], [504, 738],
      ], { stroke: INK, width: 36.8 });

      // s9  box [508 579 512 695]  length 118px
      through([
        [509, 579], [508, 691], [512, 695],
      ], { stroke: INK, width: 36 });

      // s10  box [433 738 504 804]  length 108px
      through([
        [504, 738], [476, 747], [465, 757], [441, 780], [433, 804],
      ], { stroke: INK, width: 36.8 });

      // s11  box [433 804 456 878]  length 90px
      through([
      ...
      // s15  box [250 166 265 181]  length 21px
      through([
        [265, 166], [250, 181],
      ], { stroke: INK, width: 35.6 });

      // s16  box [437 878 447 890]  length 18px
      through([
        [447, 878], [444, 886], [437, 890],
      ], { stroke: INK, width: 35.6 });

      // s17  box [362 379 364 391]  length 13px
      through([
        [364, 379], [362, 391],
      ], { stroke: INK, width: 46.7 });

      // s18  box [356 159 363 166]  length 10px
      through([
        [356, 159], [363, 166],
      ], { stroke: INK, width: 36.1 });

      // s19  box [578 645 585 652]  length 10px
      through([
        [585, 645], [578, 652],
      ], { stroke: INK, width: 35.4 });

      // s20  box [451 763 458 770]  length 10px
      through([
        [458, 763], [451, 770],
      ], { stroke: INK, width: 35.4 });

      // s21  box [611 426 616 431]  length 7px
      through([
        [611, 426], [616, 431],
      ], { stroke: INK, width: 36.7 });

      // s22  box [435 484 440 489]  length 7px
      through([
        [435, 484], [440, 489],
      ], { stroke: INK, width: 36.1 });

      // s23  box [240 662 245 667]  length 7px
      through([
        [240, 662], [245, 667],
      ], { stroke: INK, width: 36.7 });
    });
